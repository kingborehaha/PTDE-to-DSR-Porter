...
namespace SoulsFormatsExtensions
{
    public partial class FXR1
    {
        ...
        {
            public FXField Unk1 = new FXField.ConstFloat(1);
            public FXField Unk2 = new FXField.ConstFloat(1);
            public FXField Unk3 = new FXField.ConstFloat(1);
            public FXField Unk4 = new FXField.ConstFloat(1);
            public FXField Unk5 = new FXField.ConstFloat(1);
            public float Unk6 = 0;
            public int Unk7 = 0;
            public int Unk8 = 0;
            public int Unk9 = 0;
            ...
            internal void WriteEmpty(BinaryWriterEx bw, FXActionData beh)
            {
                beh.WriteField(Unk1);
                beh.WriteField(Unk2);
                beh.WriteField(Unk3);
